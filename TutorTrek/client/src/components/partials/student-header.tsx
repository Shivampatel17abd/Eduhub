...
const navigation = [
  ...
  { name: "Text to Speech", href: "/community", current: false },
  {name:"Extention",href:"https://chromewebstore.google.com/detail/screen-reader/kgejglhpjiefppelpmljglcjbhoiplfn",current:false},
...
const StudentHeader: React.FC = () => {
  ...
  return (
    <div className='bg-gray-00 border-b border-b-gray-300 '>
      <Disclosure
        as='nav'
