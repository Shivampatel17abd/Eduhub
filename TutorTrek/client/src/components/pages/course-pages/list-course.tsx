  ...
  const courses = [
    {
      ...
      price:2000,
      isPaid:true,
      title:"Alpha course for Beginars",
      thumbnailUrl:"https://th.bing.com/th/id/OIP.2vUTawLyzalDoTv7zF6JTQHaEo?rs=1&pid=ImgDetMain",
      description:"this is a java program for beginars to Advanse"
    },
    {
      _id:"#",
      rating:3,
      ...
      isPaid:true,
      title:"Delta",
      thumbnailUrl:"https://th.bing.com/th/id/OIP.3JZTRIWrJ4xaOUHpHFcLqgAAAA?rs=1&pid=ImgDetMain",
      description:"this is a java program for beginars to Advanse"
    },
    {
      _id:"#",
      ...
      thumbnailUrl:"https://img.youtube.com/vi/vVnkU1fTM_w/hqdefault.jpg",
      description:"this is a java program for beginars to Advanse"
    },
    {
      _id:"#",
      ...
      isPaid:true,
      title:"Data Science",
      thumbnailUrl:"https://i.ytimg.com/vi/MFv2v86C8VI/maxresdefault.jpg",
      description:"this is a java program for beginars to Advanse"
    },
    {
      _id:"#",
      ...
      price:2000,
      isPaid:true,
      title:"Alpha course for Beginnars",
      thumbnailUrl:"https://i.ytimg.com/vi/oFvNdsgWMmk/maxresdefault.jpg",
      description:"this is a java program for beginars to Advanse"
    },
    {
      _id:"#",
      ...
      price:2000,
      isPaid:true,
      title:"JavaScript for Begniers",
      thumbnailUrl:"https://th.bing.com/th/id/OIP.U16Sxl3a_xpV8R3xDGgMdQAAAA?rs=1&pid=ImgDetMain",
      description:"this is a java program for beginars to Advanse"
    },
  ...
  return (
        ...
        <div className='text-customFontColorBlack'>
          ...
          <div className='mx-auto flex justify-center'>
            <div className=' min-w-12/13 ml-24 mr-24 gap-x-11'>
  ...
  {courses.length ? (
                  courses.map((course) => (
                    // <Link to={course._id} key={course._id} className='mt-5'>
                      <div className='m-2 w-80 flex mt-8 cursor-pointer '>


                       {/* <CourseCard {...course}/> */}
                       {/* <div className="min-h-fit w-44 "> */}
